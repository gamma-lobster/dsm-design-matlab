...
plot_path = fullfile(results_dir, 'dsm_3rd_order_ciff_10mhz_simulink_plots.png');
saveas(fig1, plot_path);

results_path = fullfile(results_dir, 'dsm_3rd_order_ciff_10mhz_simulink_results.mat');
