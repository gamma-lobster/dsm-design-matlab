...
6. Run `references/run_3rd_order_simulink_model.m` to verify the generated discrete-time Simulink topology path.
7. Run `references/design_4th_order_ciff_with_dac_mismatch.m` if the next focus is DAC mismatch or DWA behavior.
